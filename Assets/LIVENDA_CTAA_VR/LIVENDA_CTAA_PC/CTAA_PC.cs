...
public class CTAA_PC : MonoBehaviour {
	...
	[Space(5)]
	[Range(0.001f, 10.0f)] public float HdrResponse   = 1.0f;
	[Space(5)]
	[Range(0.0f, 10.0f)] public float Sharpness   = 9.5f;
	[Space(5)]
	[Range(0.0f, 0.5f)] public float AdaptiveEnhance       = 0.03f;
	[Space(5)]
	...
	void OnRenderImage (RenderTexture source, RenderTexture destination)
	{
		...
		if (CTAA_Enabled) {
			...
			ctaaMat.SetVector ("_ControlParams", new Vector4 (0, (float)TemporalStability, HdrResponse, Sharpness));
